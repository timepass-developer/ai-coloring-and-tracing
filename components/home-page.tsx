  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <footer className="mt-auto bg-white/90 px-6 py-12 text-slate-700 shadow-inner md:px-12 lg:px-20">
          <div className="mx-auto grid w-full max-w-6xl gap-10 md:grid-cols-[1.2fr,1fr,1fr,1fr]">
            ...
            <div>
              <h5 className="mb-3 text-sm font-semibold text-slate-900">Discover</h5>
            ...
            <div>
              <h5 className="mb-3 text-sm font-semibold text-slate-900">Learn</h5>
              <ul className="space-y-2 text-sm">
                <li>
            ...
            <div>
              <h5 className="mb-3 text-sm font-semibold text-slate-900">Support</h5>
              <ul className="space-y-2 text-sm">
                <li>
